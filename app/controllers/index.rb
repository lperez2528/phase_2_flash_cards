...
post '/play/:round_id/:card_id' do
  ...
  if @user_answer == @current_card.answer
    ...
    redirect to "/game_complete/#{@current_card.id}/#{@correctness}/"
    ...
    redirect to "/game_complete/#{@current_card.id}/"
  end
end
...
get "/game_complete/:card_id/" do
  @current_card = Card.find(params[:card_id])
  erb :game_complete
end


get "/game_complete/:card_id/:correctness/" do
  @current_card = Card.find(params[:card_id])
  @correctness = params[:correctness]
  erb :game_complete
end
